...
const index = () => {
  ...
  useEffect(() => {
    if (contract) fetchSponsors()
  }, [contract, address])

  const handleSponsor = async () => {
    setIsLoading(true)

    await sponsor(grant.pId, amount)
    ...
    <div>
      ...
      <div className='w-full flex md:flex-row flex-col mt-10 gap-[30px]'>
        ...
        <div className='flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]'>
          ...
          />
          <CountBox title='Total Backers' value={sponsors.length} />
        </div>
      </div>
